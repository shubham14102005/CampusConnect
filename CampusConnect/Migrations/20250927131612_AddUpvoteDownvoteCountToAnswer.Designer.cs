...
namespace CampusConnect.Migrations
{
    ...
    [Migration("20250927131612_AddUpvoteDownvoteCountToAnswer")]
    partial class AddUpvoteDownvoteCountToAnswer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CampusConnect.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("FunctioningTitle")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CampusConnect.Models.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CampusConnect.Models.AnswerVote", b =>
                {
                    b.HasOne("CampusConnect.Models.Answer", "Answer")
            ...
            modelBuilder.Entity("CampusConnect.Models.QuestionTag", b =>
                {
                    ...
                    b.HasOne("CampusConnect.Models.Tag", "Tag")
                        .WithMany("QuestionTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
